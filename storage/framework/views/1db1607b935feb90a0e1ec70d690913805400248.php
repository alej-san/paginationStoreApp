        ...
        <table class="table table-striped" id="userTable">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <?php echo e($yate->tnombre); ?>  <!-- usando el método tipo (belongsTo) de la clase Yate -->
                    </td>
                     <td>
                        <?php echo e($yate->desde); ?> <!-- usando el método astillero (belongsTo) de la clase Yate -->
                    </td>
                    <td>
                        <?php echo e($yate->hasta); ?> <!-- usando el método astillero (belongsTo) de la clase Yate -->
                    </td>
                     <td>
                        <?php echo e($yate->anombre); ?> <!-- usando el método astillero (belongsTo) de la clase Yate -->
                    </td>
                    <td>
                        <?php echo e($yate->uname); ?> <!-- usando el método user (belongsTo) de la clase Yate -->
                    </td>
                 
                    <td>
                        <?php echo e($yate->email); ?> <!-- usando el método astillero (belongsTo) de la clase Yate -->
                    </td>
                    <td>
                        <?php echo e($yate->type); ?> <!-- usando el método astillero (belongsTo) de la clase Yate -->
                    </td>
         ...
         <?php $__currentLoopData = $links; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $link): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <li class="page-item"><a class="page-link" href="<?php echo e($link['url']); ?>"></a></li>
         <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
         </ul>
    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/laraveles/pagination/resources/views/yate/index2.blade.php ENDPATH**/ ?>